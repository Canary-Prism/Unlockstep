...
public class LockstepR1 extends Lockstep {
    ...
    public LockstepR1(JFrame frame, String music_path, String audio_path, String sprite_path,
    ...
    protected void setup() {
        audio_conductor.submit((e) -> {
            if (e.beat() == 159) {
                audio_conductor.setTempo(60_000, 150 * 2);
            } else if (e.beat() == 159 + 96) {
                audio_conductor.setTempo(60_000, 170 * 2);
            } else if (e.beat() == 159 + 96 + 96) {
                audio_conductor.setTempo(60_000, 150 * 2);
            }
        });
        audio_conductor.submit((e) -> {
        ...
        visuals_conductor.submit((e) -> {
            if (e.beat() == 159) {
                visuals_conductor.setTempo(60_000, 150 * 2);
                input_handler.queueSetTempo(60_000, 150 * 2);
            } else if (e.beat() == 159 + 96) {
                visuals_conductor.setTempo(60_000, 170 * 2);
                input_handler.queueSetTempo(60_000, 170 * 2);
            } else if (e.beat() == 159 + 96 + 96) {
                visuals_conductor.setTempo(60_000, 150 * 2);
                input_handler.queueSetTempo(60_000, 150 * 2);
            }
